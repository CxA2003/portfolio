          ...
          <div className="project-grid">
            ...
            <a target="_blank" rel="noopener noreferrer" className="project-link">
              <div className="project-card">
                ...
                <div className="project-img">
                  <img src="src/assets/copy-icon.svg" alt="Trade Replication System Image" />
                </div>
              </div>
            </a>
            ...
            <a href="https://github.com/CxA2003/weapon-identification" target="_blank" rel="noopener noreferrer" className="project-link">
              <div className="project-card">
                ...
                <div className="project-img">
                  <img src="src/assets/picture-icon.svg" alt="Weapon Identification Image" />
                </div>
              </div>
            </a>
            ...
            <a href="https://cxa2003.github.io/random-quotes/" target="_blank" rel="noopener noreferrer" className="project-link">
              <div className="project-card">
                ...
                <div className="project-img">
                  <img src="src/assets/random-icon.svg" alt="Random Quotes Image" />
                </div>
              </div>
            </a>
            ...
            <a href="https://github.com/CxA2003/Pyculator" target="_blank" rel="noopener noreferrer" className="project-link">
              <div className="project-card">
                ...
                <div className="project-img">
                  <img src="src/assets/calculator-icon.svg" alt="Calculator Image" />
                </div>
              </div>
            </a>
        ...
        <section id="education" className="max-w-6xl mx-auto p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-gray-200 p-4 rounded-lg shadow-md text-center">
              <img src="src/assets/fiu-logo.png" alt="Coursera Logo" className='edu-image' />
              <p>Computer Science B.S. - FIU (some college)</p>
            </div>
            <div className="bg-gray-200 p-4 rounded-lg shadow-md text-center">
              <img src="src/assets/ga-logo.png" alt="Coursera Logo" className='edu-image' />
              <p>Data Science Bootcamp - General Assembly</p>
            </div>
            <div className="bg-gray-200 p-4 rounded-lg shadow-md text-center">
              <img src="src/assets/platzi-logo.png" alt="Coursera Logo" className='edu-image' />
              <p>Data Science Learning Route - Platzi</p>
            </div>
            <div className="bg-gray-200 p-4 rounded-lg shadow-md text-center">
              <img src="src/assets/lasalle-logo.jpeg" alt="Coursera Logo" className='edu-image' />
        ...
        <section id="certifications" className="max-w-6xl mx-auto p-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <a
              ...
              className="cert-card"
            >
              <img src="src/assets/coursera-logo.svg" alt="Coursera Logo" className="cert-image" />
            ...
            <a
              ...
              className="cert-card"
            >
              <img src="src/assets/freecodecamp-logo.svg" alt="freeCodeCamp Logo" className="cert-image" />
